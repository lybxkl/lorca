...
//    	    	break;
   ...
   * up to 128 seconds.
	...
	var Client = function (host, port, path, clientId) {
		 ...
		 * @function
		 * @param {{invocationContext: {path: *, clientId: *, port: *, host: *}, keepAliveInterval: number, password: *, onFailure: onFailure, userName: *, cleanSession: boolean, timeout: number, useSSL: boolean, onSuccess: *}} connectOptions - Attributes used with the connection.
